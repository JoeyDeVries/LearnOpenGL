...
The CMake script knows where to find the libraries, so just run CMake script and generate the project of choice.
...
Running `ls $LOGL_ROOT_PATH` should list, among other things, this README file and the resources diretcory.
