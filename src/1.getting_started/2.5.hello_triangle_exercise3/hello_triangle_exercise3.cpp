...
int main()
{
    ...
    unsigned int fragmentShaderMine = glCreateShader(GL_FRAGMENT_SHADER);

    unsigned int shaderProgramOrange = glCreateProgram();
    unsigned int shaderProgramYellow = glCreateProgram(); // the second shader program
    unsigned int shaderProgramMine = glCreateProgram();
    ...
    glShaderSource(fragmentShaderMine, 1, &fragmentShader3Source, NULL);
